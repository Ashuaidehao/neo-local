...
class PrivnetClaimall(object):
    ...
    def send_neo(wallet, address_from, address_to, amount):
        '''
        transfer neo from address_from to address_to;
        if signed successfully, return ContractParametersContext.ToJson(),wait for relay
        '''
        assetId = None
        ...
        if context.Completed==False:
            ...
            print("Transaction initiated: %s" % tx.ToJson())
    ...
    def wait_for_tx(self, tx, max_seconds=30):
